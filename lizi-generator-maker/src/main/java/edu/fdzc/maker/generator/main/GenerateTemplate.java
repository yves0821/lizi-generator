package edu.fdzc.maker.generator.main;

import cn.hutool.core.io.FileUtil;
import cn.hutool.core.io.resource.ClassPathResource;
import cn.hutool.core.util.StrUtil;
import edu.fdzc.maker.generator.JarGenerator;
import edu.fdzc.maker.generator.ScriptGenerator;
import edu.fdzc.maker.generator.file.DynamicFileGenerator;
import edu.fdzc.maker.meta.Meta;
import edu.fdzc.maker.meta.MetaManager;
...
public abstract class GenerateTemplate {
    ...
    protected void buildDist(String outputPath, String sourceCopyDestPath, String jarPath, String shellOutputFilePath) {
        ...
        System.out.println("测试一下 ：" + targetAbsolutePath);
    ...
    private static void generateCode(Meta meta, String outputPath) throws IOException, TemplateException {
        // 读取 resources 目录,获取 classpath 根目录的绝对路径
