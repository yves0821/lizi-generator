...
import edu.fdzc.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "lizi");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "edu.fdzc");
